				...
				<div class="committees">
					...
					<div class="committee-options">
						...
						while ( $loop->have_posts() ) : $loop->the_post();
							...
							$slug = $post->post_name;
							echo '<li><a id="'. $slug .'" class="committee-name" href="#">'.get_the_title().'</a></li>
										';
						endwhile;
						...
						while ( $studentDirectorloop->have_posts() ) : $studentDirectorloop->the_post();
							$slug = $post->post_name;
							echo '<li><a id="'. $slug .'" class="director-title" href="#">Student Director</a></li>
										';
						endwhile;
						...
						while ( $asstStudentDirectorloop->have_posts() ) : $asstStudentDirectorloop->the_post();
							$slug = $post->post_name;
							echo '<li><a id="'. $slug .'" class="director-title" href="#">Assistant Student Director</a></li>
										';
						endwhile;
						...
						while ( $gradAsstloop->have_posts() ) : $gradAsstloop->the_post();
							$slug = $post->post_name;
							echo '<li><a id="'. $slug .'" class="director-title" href="#">Graduate Assistant</a></li>
										';
						endwhile; ?>
					</ul>
					</div>	
